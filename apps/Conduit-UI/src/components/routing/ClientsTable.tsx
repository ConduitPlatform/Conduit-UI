        ...
        <Paper sx={{ p: 4, borderRadius: 8 }}>
          <Box display="flex" justifyContent="space-between" alignItems="center">
            ...
            <Button
              ...
              disabled={!config.security?.clientValidation}>
              {<Add />}
                      ...
                      <TableCell>
                        <Box display="flex" justifyContent="flex-end" gap={1}>
                          <Tooltip title="Delete security client">
                            <IconButton
                              onClick={() => handleDeletion(client._id)}
                              disabled={!config.security?.clientValidation}>
                              <DeleteIcon
                                color={!config.security?.clientValidation ? 'disabled' : 'error'}
                              />
                            </IconButton>
                          </Tooltip>
                          <Tooltip title="Edit security client">
                            <IconButton
                              ...
                              disabled={!config.security?.clientValidation}>
                              <Edit
                                color={!config.security?.clientValidation ? 'disabled' : 'primary'}
                              />
                            </IconButton>
                          </Tooltip>
                        </Box>
