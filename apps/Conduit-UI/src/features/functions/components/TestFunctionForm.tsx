...
import { EmailTemplateType, EmailUI } from '../models/FunctionsModels';
...
import { asyncGetEmailTemplates, asyncSendEmail } from '../store/functionsSlice';
...
const TestFunctionForm: React.FC = () => {
