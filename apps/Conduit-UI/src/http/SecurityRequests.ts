...
import ClientPlatformEnum, { ISecurityConfig } from '../models/security/SecurityModels';

export const getAvailableClientsRequest = () => {
  return axios.get(`${CONDUIT_API}/admin/security/client`);
};

export const generateNewClientRequest = (platform: ClientPlatformEnum, domain?: string) => {
