export const SocketIcon = ({ className }: {
  className?: string
}) => {
  return <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 256 256" preserveAspectRatio="xMinYMin meet">
    <circle cx="128" cy="128" r="114" stroke="currentColor" strokeWidth="20" />
    <path
