...
import { NotificationSettings } from '@/lib/models/Notifications';
                ...
                <SelectContent className={'bg-white dark:bg-popover'}>
                  ...
                  <SelectItem value={'firebase'}>
                    <div className={'flex items-center gap-2'}>
                      Firebase {data.firebase && watch('providerName') !== 'firebase' && <Cog />}
                    </div>
                  </SelectItem>
                  <SelectItem value={'oneSignal'}>
                    <div className={'flex items-center gap-2'}>
                      OneSignal {data.onesignal && watch('providerName') !== 'oneSignal' && <Cog />}
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
