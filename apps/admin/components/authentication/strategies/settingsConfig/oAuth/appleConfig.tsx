...
export const AppleConfigForm: React.FC<StrategyFormProps<authStrategyFormType>> = ({ data, onSubmit, onCancel }) => {
  ...
  return <Form {...form}>
    <form onSubmit={form.handleSubmit(onSubmit)}>
      <div className={'flex flex-col gap-1'}>
        ...
        <TextAreaField label={'Private Key'} fieldName={'privateKey'} placeholder={''} />
