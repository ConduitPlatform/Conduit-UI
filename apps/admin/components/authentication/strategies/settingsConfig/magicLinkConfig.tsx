...
export const MagicLinkConfigForm: React.FC<StrategyFormProps<authStrategyFormType>> = ({
                                                                                         data,
                                                                                         onSubmit,
                                                                                         onCancel,
                                                                                       }) => {
    ...
    <form onSubmit={form.handleSubmit(onSubmit)}>
      <div className={'flex flex-col gap-1'}>
        ...
        <div className={'flex flex-row gap-x-1 items-center'}>
          <InputField fieldName={'redirect_uri'} label={'Success redirect URI'}
                      description={'Specify where the user will be redirected to after successful consumption of the magic link'} />
        </div>
        <div className={'flex flex-row gap-x-1 items-center'}>
          <InputField fieldName={'link_uri'} label={'Forgot password redirect URI (optional)'}
                      description={'Specify where the user will be redirected to after clicking the magic link in their email. If provided you need to manually exchange the magic link token for an access token'} />
        </div>
