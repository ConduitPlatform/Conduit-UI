    ...
    addAlert({
      ...
      onDecision: cancel => {
        if (!cancel) {
          ...
          patchFormsSettings(updatedSettings)
            .then(res => {
              dismiss();
              toast({
                title: 'Forms',
      ...
      <div className={'flex flex-col gap-6'}>
        <div className="space-y-0.5">
          <div className={'flex gap-2 items-center'}>
            <p className="text-2xl font-medium">Forms Module</p>
            <Switch
              checked={formsModule}
              onCheckedChange={() => {
                handleSwitchChange();
          ...
          <div className={'pr-2'}>
            <p className={'text-xs text-[#94A3B8]'}>
              To see more information regarding the Forms config, visit our{' '}
              <a
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="flex gap-x-5 items-center">
                ...
                <div className=" w-5/12 flex items-center justify-center gap-x-4 rounded-md border p-4">
                  <ShieldCheck />
                  <div className="flex-1 space-y-1">
                    <p className="text-sm font-medium leading-none">Captcha</p>
                    <p className="text-sm text-muted-foreground w-11/12">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormControl>
                        <Switch
                          disabled={
                            !edit || (!field.value && !captchaAvailable)
                          }
                          checked={field.value}
                          onCheckedChange={field.onChange}
                        />
