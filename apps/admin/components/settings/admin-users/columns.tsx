...
import { CheckIcon, Clipboard, KeyRound, LucideX, Trash, UserCheck } from 'lucide-react';
            ...
            toast({
              ...
              description: (
                <div className={'flex flex-row items-center space-x-2.5'}>
                  ...
                  <p className='text-sm text-foreground'>Admin deleted successfully!</p>
                </div>
              ),
            });
            router.refresh()
