...
export const getAdmins = async (skip: number, limit: number): Promise<{ admins: Admin[], count: number }> => {
...
export const changeAdminsPasswordById = async (adminId: string, newPassword: string) => {
