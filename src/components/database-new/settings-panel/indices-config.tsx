...
export function IndicesConfig({
  ...
  const getIndexTypeLabel = (type: string | undefined) => {
    const option = indexTypeOptions.find(o => o.value === type);
    return option?.label || type || 'Ascending';
  };
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary" className="text-xs">
                        {getIndexTypeLabel(index.types?.[0])}
                      </Badge>
                    </div>
